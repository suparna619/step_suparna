...
test.sort_points_by_distance_from_a_given_point = function(){
	...
	var c = new r.Point(0,7);
	var d = new r.Point(3,4);	
	assert.deepEqual([a,c,b,d].sort(x.compareDistance),[d,b,a,c]);
};
...
test.round_off_amount_to_25_paise = function(){
	assert.deepEqual([12.36,423.56,12.99,92.23,100.02,11.12,9.7234].
		map(r.to.round_25_paise),[12.25,423.50,13,92.25,100,11,9.75]);
};
